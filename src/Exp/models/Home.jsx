...
export default memo(function Model({ progress = 0, ...props }) {
  ...
  return (
    <group {...props} dispose={null}>
      {/* Home Set 1T */}
      <mesh geometry={n1.BarrelBottom_Baked.geometry} material={mat1.HomeItems1_Baked} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />
     
      {/* Home Set 2T */}
      <mesh geometry={n2.BirchPlanks_Baked.geometry} material={mat2.HomeItems2_Baked} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />

      {/* Home Set 3T */}
       <mesh geometry={n3.ArmorDiamondLayer1_Baked.geometry} material={mat3.H3SET_Baked} position={[1.643, 14.744, 1.654]} />

      {/* Home Set 4T */}
     <mesh geometry={n4.AmethystCluster_Baked.geometry} material={mat4.HomeItems4_Baked} position={[5.084, 23.287, 8.276]} rotation={[Math.PI / 2, 0, Math.PI]} />

      {/* Home Set 5T */}
      <mesh geometry={n5.CampfireLog_Baked.geometry} material={mat5.HomeItems5_Baked} position={[1.643, 14.744, 1.654]} />

      {/* Home Set 6T */}
      <mesh geometry={n6.OakLeavesOnHome_Baked.geometry} material={mat6.HomeItems6__Baked} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />
      ...
      <mesh geometry={n7.LanternsInside_Baked.geometry} material={mat7['LanternsInside_Baked.001']} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={n7.SoulLanterns_Baked.geometry} material={mat7['SoulLanterns_Baked.001']} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />
      <mesh geometry={n7.LanternsOutside002_Baked.geometry} material={mat7['LanternsOutside.002_Baked.001']} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />
      ...
      {/* Home Set WT */}
     <mesh geometry={n9.HouseOakLog_Baked.geometry} material={mat9.WoodenItems_Baked} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />
      ...
      {/* Home Set RT */}
      <mesh geometry={n11.RoofExterior_Baked.geometry} material={mat11['RoofSet_Baked.001']} position={[1.643, 14.744, 1.654]} rotation={[Math.PI / 2, 0, 0]} />
      {/* Home Set DT */}
      <mesh ref={doorRef} geometry={n12.FrontDoor_Baked.geometry} material={mat12['FrontDoor_Baked.002']} position={[-1.36, 17.788, 11.781]} rotation={[Math.PI / 2, 0, 0]} />
      {/* Home Set HT */}
      <mesh geometry={n13.HomeWalls_Baked.geometry} material={mat13['HomeWalls_Baked.001']} position={[4.584, 13.787, 2.776]} rotation={[Math.PI / 2, 0, 0]} />
       <mesh geometry={n14.Chain_Baked.geometry} material={mat14['Chain_Baked.001']} position={[1.643, 14.744, 1.654]} />
    </group>
  )
});
