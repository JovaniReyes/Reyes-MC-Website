...
const setPhotos = (materials) =>{
    ...
    Object.entries(uniqueMaterials).forEach(([name, ids]) => {
        ...
        if(materials[name] == null) return;
        ids.forEach(id => {
            sets[id] = {base: original.clone(), pulse: original.clone(), hover: original.clone()};
...
//     // Create material sets for each unique material type
//     Object.entries(computerMaterials).forEach(([materialName, ids]) => {
